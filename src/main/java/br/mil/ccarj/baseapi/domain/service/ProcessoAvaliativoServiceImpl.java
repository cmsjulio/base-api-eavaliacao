...
public class ProcessoAvaliativoServiceImpl implements ProcessoAvaliativoService{
    ...
    public ProcessoAvaliativoServiceImpl(ProcessoAvaliativoRepository repository) {this.repository = repository;}

    @Override
    public ProcessoAvaliativo create(ProcessoAvaliativo entity) {return repository.save(entity);}
    ...
    @Override
    public Page<ProcessoAvaliativo> findAll(Pageable pageable) {return repository.findAll(pageable);}
