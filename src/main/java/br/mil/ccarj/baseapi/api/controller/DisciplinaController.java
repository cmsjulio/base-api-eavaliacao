...
public class DisciplinaController extends BaseController{
    ...
    public DisciplinaController (DisciplinaService disciplinaService, ModelMapper modelMapper){
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 204, message = "sucessful operation", response = DisciplinaResponse.class),
            @ApiResponse(code = 400, message = "Bad Request"),
            @ApiResponse(code = 404, message = "Disciplina not found")})
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "sucessful operation", response=DisciplinaResponse.class),
            @ApiResponse(code = 400, message = "Bad Request"),
            @ApiResponse(code = 404, message = "Disciplina not found")})

    @DeleteMapping(value = "/{id}")
    @ResponseBody
    public void delete (@PathVariable (name="id") Long id) {disciplinaService.delete(id);}
